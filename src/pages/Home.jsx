  ...
  return (
    <div className="min-h-[calc(100vh-120px)] relative">
      ...
      <div className="w-[50%] pt-[8%] px-14">
        ...
        <a class="mr-6 btn btn-md relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-semibold transition-all bg-[#2AAAB8] border border-[#1D3F72] rounded-none hover:bg-white group">
